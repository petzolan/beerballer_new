...
class ShopCategoryOverviewTab extends StatefulWidget {
  QueryDocumentSnapshot<dynamic> categoryItem;
  // String categoryName;
  // String shopitemCategoryName;
  ShopCategoryOverviewTab(this.categoryItem);

  // ShopCategoryOverviewTab(this.categoryName, this.shopitemCategoryName);

  @override
  _ShopCategoryOverviewTabState createState() =>
      _ShopCategoryOverviewTabState();
}

class _ShopCategoryOverviewTabState extends State<ShopCategoryOverviewTab> {
  ...
  void initState() {
    ...
    switch (item.name) {
      case "Beer Pong":
        ...
        break;
      case "Trinkspiele":
        callback("Trinkspiele");
        break;
      case "Clothing":
        callback("Shirts");
        break;
      case "Events":
        callback("Bar Bachelor");
        break;
    }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Categories
          CategoryList(callback, item.categories),
          // Einzelnen Cards
          Flexible(
            child: StreamBuilder(
              stream: this.streamProducts,
